...
## 8. Spring Security + JWT Authentication & Authorization
...
### 8.2. Estructura de Archivos (OBLIGATORIA)
...
### 8.4. JwtTokenProvider (Core Component)
...
### 8.5. JwtAuthenticationFilter (HTTP Filter)
...
### 8.6. SecurityConfig (Configuración Principal)
...
### 8.7. Configuración (application.yaml)
...
### 8.10. Best Practices OBLIGATORIAS
...
### 8.12. Checklist de Implementación
