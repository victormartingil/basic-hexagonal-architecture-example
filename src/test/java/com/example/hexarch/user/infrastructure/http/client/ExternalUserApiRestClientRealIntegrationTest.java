...
/**
 * INTEGRATION TEST - ExternalUserApiRestClient (REAL API CALLS)
 * <p>
 ...
 * </p>
 * <p>
 * La lógica de ExternalUserApiRestClient está cubierta por ExternalUserApiRestClientTest con mocks,
 ...
 * ./mvnw test -Dtest=ExternalUserApiRestClientRealIntegrationTest
 * </pre>
 *
 * @see <a href="https://jsonplaceholder.typicode.com/">JSONPlaceholder API</a>
 */
@Tag("integration")  // Para ejecutar selectivamente
@DisplayName("ExternalUserApiRestClient - Real API Integration Test")
class ExternalUserApiRestClientRealIntegrationTest {
    ...
    void setUp() {
        ...
        // Usando SimpleClientHttpRequestFactory (no deprecado)
